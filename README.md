...
| Действие                                                                           | Ожидаемый результат                         |
| ---------------------------------------------------------------------------------- | ------------------------------------------- |
| После создания задачи пользователь переходит в Telegram, открывает диалог чат-бота | Открылся чат с ботом                        |
| Пользователь дожидается получения уведомления от чат-бота                          | Чат-бот отправляет уведомление пользователю |
...
| Перейти по url: [http://localhost:8081/](http://localhost:8081/)                                           | Открылась страница авторизации                                          |
| Ввести корректные данные для авторизации, нажать кнопку “Войти”                                            | Отображается токен, появляется доступ к функционалу                     |
| Перейти по url: [http://localhost:8084/swagger-ui/index.html](http://localhost:8084/swagger-ui/index.html) | Открылась страница swagger                                              |
| Отправить POST запрос на PublicationController /publications                                               | Ответ 201\:documented, с телом, содержащим данные сохраненной публикаци |
...
| Ввести корректные данные для авторизации, нажать кнопку “Войти”                                            | Отображается токен, появляется доступ к функционалу                             |
| Перейти по url: [http://localhost:8084/swagger-ui/index.html](http://localhost:8084/swagger-ui/index.html) | Открылась страница swagger                                                      |
| Отправить GET запрос на PublicationController /publications/\*                                             | Ответ 200 с телом, содержащим данные публикаций за выбранный промежуток времени |
...
| Ввести корректные данные для авторизации, нажать кнопку “Войти”                                            | Отображается токен, появляется доступ к функционалу                     |
| Перейти по url: [http://localhost:8084/swagger-ui/index.html](http://localhost:8084/swagger-ui/index.html) | Открылась страница swagger                                              |
| Отправить POST запрос на CommentController /comment/by-publication/{publicationId}                         | Ответ 201\:documented с телом, содержащим данные созданного комментария |

## Просмотр актуальных задач
| Действие                                                                                           | Ожидаемый результат                       |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------- |
| Перейти по url: [http://localhost:8083/calendar/{userId}](http://localhost:8083/calendar/{userId}) | Открылась страница с календарем           |
| Нажать на кнопку see actual                                                                        | В правом окне появились актуальные задачи |

## Просмотр комментария к публикации
| Действие                                                                                                   | Ожидаемый результат                                              |
| ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| Перейти по url: [http://localhost:8081/](http://localhost:8081/)                                           | Открылась страница авторизации                                   |
| Ввести корректные данные для авторизации, нажать кнопку “Войти”                                            | Отображается токен, появляется доступ к функционалу              |
| Перейти по url: [http://localhost:8084/swagger-ui/index.html](http://localhost:8084/swagger-ui/index.html) | Открылась страница swagger                                       |
| Отправить GET запрос на CommentController /comment/by-publication/{publicationId}                          | Ответ 200 с телом, содержащим комментарии к выбранной публикации |
...
| Ввести корректные данные для авторизации, нажать кнопку “Войти”                                            | Отображается токен, появляется доступ к функционалу |
| Перейти по url: [http://localhost:8084/swagger-ui/index.html](http://localhost:8084/swagger-ui/index.html) | Открылась страница swagger                          |
| Отправить DELETE запрос на PublicationController /publications/{id}                                        | Ответ 204                                           |
...
| Ввести корректные данные для авторизации, нажать кнопку “Войти”                                            | Отображается токен, появляется доступ к функционалу |
| Перейти по url: [http://localhost:8084/swagger-ui/index.html](http://localhost:8084/swagger-ui/index.html) | Открылась страница swagger                          |
| Отправить DELETE запрос на CommentController /comments/{id}                                                | Ответ 204                                           |
